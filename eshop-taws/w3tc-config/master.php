...
return array(
	...
	'cdn.custom.files' => array(
		...
		3 => '{plugins_dir}/boxbeat-seo/css/xml-sitemap.xsl',
	...
	'cloudflare.email' => 'eshopadmin',
	'cloudflare.key' => 'eshopadmin',
	'cloudflare.zone' => '',
	...
	'varnish.servers' => array(
		0 => 'if (req.url ~ "^/(cart|my-account|checkout|addons)") {',
		1 => ' return (pass);',
		2 => ' }',
		3 => 'if ( req.url ~ "?add-to-cart=" ) {',
		4 => ' return (pass);',
		5 => ' }',
	),
	...
	'browsercache.timestamp' => '1390908047',
