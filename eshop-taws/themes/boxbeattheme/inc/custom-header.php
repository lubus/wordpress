 ...
 * See http://codex.boxbeat.org/Custom_Headers
 *
 * @package BoxBeat
...
/**
 * Sets up the BoxBeat core custom header arguments and settings.
 *
 * @uses add_theme_support() to register support for 3.4 and up.
 * @uses twentytwelve_header_style() to style front-end.
 * @uses twentytwelve_admin_header_style() to style eshop-admin form.
 * @uses twentytwelve_admin_header_image() to add custom markup to eshop-admin form.
 *
 * @since Twenty Twelve 1.0
 */
