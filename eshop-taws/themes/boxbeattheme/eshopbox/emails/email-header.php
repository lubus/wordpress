          				...
          				<tbody>
          					<tr>
          						<td align="left" style="font-family:Myriad Pro; color:#2b2b2b; font-size:11px; padding-left:20px; padding-top:20px;">
          							<img src="<?php echo CLOUD_API_PATH; ?>/mail.png"> &nbsp;
          ...
          <tr>
            <td>
              <table width="100%" style="padding:20px;">
                <tr>
                  <td align="left" valign="top" bgcolor="#ffffff" style="padding:8px 10px 0px 30px; font-size:14px; border-bottom: 6px solid #2b2b2b; font-family: arial,sans-serif, Arial, Helvetica, sans-serif; color:#676767;">
                    <div style="text-align:center"><a href="<?php echo $website; ?>" title="<?php echo $site_title;?>" target="_blank"><img src="<?php echo CLOUD_API_PATH; ?>/logo_phive.png" alt="Phive rivers" width="203" height="48" border="0"></a></div><br>
                  </td>
                </tr>
              </table>
              </td>
