...
<p><?php _e( "We noticed that your purchase at ".$site_url." was not completed, and thought we'd check back and see if all was well. If you had any trouble buying, please click the Retry button below to try again.", 'eshopbox' ); ?></p>
<p><a href="<?php echo $website;?>">Try</a></p>
