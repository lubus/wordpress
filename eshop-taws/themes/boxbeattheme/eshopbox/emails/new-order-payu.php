...
<p><?php _e('Your order '.$orderno.' has been placed successfully.Your order will be shipped from our warehouse soon. Once your order shipped, we will send you an email with the shipment details.', 'eshopbox' ); ?></p>
...
<p><?php _e( "You can track your order at any time by going to ", 'eshopbox' ); ?><a href='<?php echo $myorder;?>'>track</a><?php _e( " page.", 'eshopbox' ); ?></p>
...
<p><?php //_e('Please do share your feedback on your order placement experience by visiting here: https://docs.google.com/forms/d/1pwUyVdwnuWTpxO8AOm727DUlWCM4zgEIMSGSgcdx_cc/viewform.','eshopbox');?></p>
