...
function cod_confirmation_block($order_id)
    {
        ...
        $cod_form='<span id="cod_confirm_msg" style="display: none">Your Order has been confirmed successfully</span>';
                $cod_form.='<div class="thanks_content">your order has been placed sucessfully and being processed.</div>';
		...
		<div class="confirm_text">To confirm your order you have to verify your Mobile No.<strong>'.$bilphnno.'</strong></div>
		<div class="mobileno_block2">
			...
			<div class="mobile_text">
				...
				<input type="text" id="cod_code"/>
				 ...
				 <input type="button" id="cod_submit" value="Verify Now!"/></br>

        <div class="courier_block">
        <input type="button" id="cod_resend" value="Resend"/>
        <div id="cod_resent_icon" style="display: none">Resent</div>
...
function load_sms_js()
{
    ...
    if($this_post_name== 'order-received')
    {
