...
function wpcf7_captcha_shortcode_handler( $tag ) {
	...
	if ( 'captchac' == $tag->type && ! class_exists( 'ReallySimpleCaptcha' ) )
		return '<em>' . __( 'To use CAPTCHA, you need <a href="http://boxbeat.org/extend/plugins/really-simple-captcha/">Really Simple CAPTCHA</a> plugin installed.', 'wpcf7' ) . '</em>';
...
<tr><td colspan="2"><strong style="color: #e6255b"><?php echo esc_html( __( "Note: To use CAPTCHA, you need Really Simple CAPTCHA plugin installed.", 'wpcf7' ) ); ?></strong><br /><a href="http://boxbeat.org/extend/plugins/really-simple-captcha/">http://boxbeat.org/extend/plugins/really-simple-captcha/</a></td></tr>
<?php endif; ?>
