...
printf( __( "Hi %s. Your recent order on %s has been completed. Your order details are shown below for your reference:", 'eshopbox' ), $customer_name,get_option( 'blogname' ) ); ?></p>
