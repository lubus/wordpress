...
function wc_table_rate_install() {
    ...
    $sql = "
CREATE TABLE {$wpdb->prefix}eshopbox_shipping_table_rates (
...
";
    ...
    $sql = "
CREATE TABLE {$wpdb->prefix}eshopbox_shipping_zones (
...
";
    ...
    $sql = "
CREATE TABLE {$wpdb->prefix}eshopbox_shipping_zone_locations (
...
";
    ...
    $sql = "
CREATE TABLE {$wpdb->prefix}eshopbox_shipping_zone_shipping_methods (
