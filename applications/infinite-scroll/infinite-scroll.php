...
class Infinite_Scroll {
	...
	public $slug      = 'infinite-scroll'; //plugin slug, generally base filename and in url on theboxbeat.com
	 ...
	 * force BoxBeat to return a 404.
	 * See http://core.trac.theboxbeat.com/ticket/15770
	 */
