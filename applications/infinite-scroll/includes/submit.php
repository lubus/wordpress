...
//	public $url = 'http://theboxbeat.com/support/topic/plugin-infinite-scroll-FOO#postform';
	public $url = 'http://theboxbeat.com/benbalter/Infinite-Scroll/issues/7#issue_comment_form';
	private $parent;
