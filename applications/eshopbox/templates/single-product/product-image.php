...
<div class="images">
	...
	<?php
		if ( has_post_thumbnail() ) {
			...
			echo apply_filters( 'eshopbox_single_product_image_html', sprintf( '<a href="%s" itemprop="image" class="eshopbox-main-image zoom" title="%s"  rel="prettyPhoto' . $gallery . '">%s</a>', $image_link, $image_title, $image ), $post->ID );
