  ...
  $('#page_slurp').click(function() {
    ...
    $.post(ajaxurl, data, function(job_id) {
      ...
      if(job_id.substring(0, 4) === 'http') {
        var msg = 'Your PHP configuration does not allow for Page Slurp from within BoxBeat. Please log into your Mijireh account and Slurp the page by pasting in the URL to this page as shown below.\
