...
<?php if ( $show_header ) : ?>
	...
	<?php if ( ! $this->getClientId() && ! $this->getAppKey() ) : //show the get started message ?>
		...
		<div id="wc_get_started">
			<span class="main"><?php _e('Setup your ShareYourCart account', 'eshopbox'); ?></span>
			<span><?php echo $wcIntegration->method_description; ?></span>
			<p><a href="<?php echo add_query_arg( 'syc-account', 'create', admin_url( 'admin.php?page=eshopbox&tab=integration&section=shareyourcart' ) ); ?>" class="button button-primary"><?php _e('Create an account', 'eshopbox'); ?></a> <a href="<?php echo add_query_arg( 'syc-account', 'recover', admin_url( 'admin.php?page=eshopbox&tab=integration&section=shareyourcart' ) ); ?>" class="button"><?php _e('Can\'t access your account?', 'eshopbox'); ?></a></p>
		</div>
...
<?php endif; ?>
    ...
    <div id="acount-options">
		<table class="form-table">
            ...
            <tr valign="top">
            	...
            	<td>
	            	...
	            	<a href="<?php echo $this->SHAREYOURCART_CONFIGURE; ?>?app_key=<?php echo $this->getAppKey(); ?>&amp;client_id=<?php echo $this->getClientId(); ?>&amp;email=<?php echo $this->getAdminEmail(); ?>" class="button" target="_blank"><?php _e('Configure', 'eshopbox'); ?></a>
        ...
        <div class="submit">
        	<input type="submit" class="button button-primary" name="syc-account-form" value="<?php _e('Save changes', 'eshopbox'); ?>" />
        </div>
    </div>
