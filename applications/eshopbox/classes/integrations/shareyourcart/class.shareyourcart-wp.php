...
*	VERSION : 1.0
*	DESCRIPTION: This class is used as a base class for every boxbeat shopping cart plugin we create.
...
if(!class_exists('ShareYourCartWordpressPlugin',false)){
	...
	*/
		...
		/**
	*
	* This is the activate hook called by BoxBeat. It is used for both install and activate
	*
	*/
		...
		/**
	*
	* This is the deactivate hook called by BoxBeat.
	*
	*/
		...
		/**
	*
	* When installing the new boxbeat plugin, make sure to move the old data
	*
	*/
	...
	*/
		public static function uninstallHook() {
			...
			//this hook is required by BoxBeat to be static
	...
	*/
		public function couponCallback(){
			...
			//since there are a lot of plugins for boxbeat, first make sure this plugin
			//is active
