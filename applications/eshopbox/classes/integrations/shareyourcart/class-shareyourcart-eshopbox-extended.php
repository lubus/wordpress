...
/**
 * ShareYourCartEshopBoxEx class.
 *
 * @extends ShareYourCartEshopBox
 */
class ShareYourCartEshopBoxEx extends ShareYourCartEshopBox {
	...
	/**
	 * Since this class has loaded, the EshopBox plugin is active.
	 *
	 * @access public
	 * @return bool
	 */
