 ...
 * @author 		WooThemes
 * @category 	Shortcodes
 * @package 	EshopBox/Shortcodes/Edit_Address
 * @version     2.0.0
 */
...
class WC_Shortcode_Edit_Address {
	...
	public static function output( $atts ) {
		...
		$address = $eshopbox->countries->get_address_fields( get_user_meta( get_current_user_id(), $load_address . '_country', true ), $load_address . '_' );

		eshopbox_get_template( 'myaccount/form-edit-address.php', array(
			'load_address' 	=> $load_address,
			'address'		=> apply_filters( 'eshopbox_address_to_edit', $address )
		) );
	}
