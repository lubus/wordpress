...
class WC_Shortcodes {
	...
	public function __construct() {
		...
		add_shortcode( 'eshopbox_messages', array( $this, 'messages_shortcode' ) );
		...
		// Pages
		add_shortcode( 'eshopbox_cart', array( $this, 'cart' ) );
		add_shortcode( 'eshopbox_checkout', array( $this, 'checkout' ) );
		add_shortcode( 'eshopbox_order_tracking', array( $this, 'order_tracking' ) );
		add_shortcode( 'eshopbox_my_account', array( $this, 'my_account' ) );
		add_shortcode( 'eshopbox_edit_address', array( $this, 'edit_address' ) );
		add_shortcode( 'eshopbox_change_password', array( $this, 'change_password' ) );
		add_shortcode( 'eshopbox_lost_password', array( $this, 'lost_password' ) );
		add_shortcode( 'eshopbox_view_order', array( $this, 'view_order' ) );
		add_shortcode( 'eshopbox_pay', array( $this, 'pay' ) );
		add_shortcode( 'eshopbox_thankyou', array( $this, 'thankyou' ) );
	}
	...
	public function cart( $atts ) {
		global $eshopbox;
		return $eshopbox->shortcode_wrapper( array( 'WC_Shortcode_Cart', 'output' ), $atts );
	}
	...
	public function checkout( $atts ) {
		global $eshopbox;
		return $eshopbox->shortcode_wrapper( array( 'WC_Shortcode_Checkout', 'output' ), $atts );
	}
	...
	public function order_tracking( $atts ) {
		global $eshopbox;
		return $eshopbox->shortcode_wrapper( array( 'WC_Shortcode_Order_Tracking', 'output' ), $atts );
	}
	...
	public function my_account( $atts ) {
		global $eshopbox;
		return $eshopbox->shortcode_wrapper( array( 'WC_Shortcode_My_Account', 'output' ), $atts );
	}
	...
	public function edit_address( $atts ) {
		global $eshopbox;
		return $eshopbox->shortcode_wrapper( array( 'WC_Shortcode_Edit_Address', 'output' ), $atts );
	}
	...
	public function change_password( $atts ) {
		global $eshopbox;
		return $eshopbox->shortcode_wrapper( array( 'WC_Shortcode_Change_Password', 'output' ), $atts );
	}
	...
	public function lost_password( $atts ) {
		global $eshopbox;
		return $eshopbox->shortcode_wrapper( array( 'WC_Shortcode_Lost_Password', 'output' ), $atts );
	}
	...
	public function view_order( $atts ) {
		global $eshopbox;
		return $eshopbox->shortcode_wrapper( array( 'WC_Shortcode_View_Order', 'output' ), $atts );
	}
	...
	public function pay( $atts ) {
		global $eshopbox;
		return $eshopbox->shortcode_wrapper( array( 'WC_Shortcode_Pay', 'output' ), $atts );
	}
	...
	public function thankyou( $atts ) {
		global $eshopbox;
		return $eshopbox->shortcode_wrapper( array( 'WC_Shortcode_Thankyou', 'output' ), $atts );
	}
	...
	public function product_category( $atts ){
		...
		$ordering_args = $eshopbox->query->get_catalog_ordering_args( $orderby, $order );
		...
		return '<div class="eshopbox">' . ob_get_clean() . '</div>';
	}
	...
	public function product_add_to_cart( $atts ) {
		...
		if ( 'product' == $product_data->post_type ) {
			...
			$product = $eshopbox->setup_product_data( $product_data );

			ob_start();
			?>
			<p class="product eshopbox" style="<?php echo $atts['style']; ?>">

				<?php echo $product->get_price_html(); ?>

				<?php eshopbox_template_loop_add_to_cart(); ?>

			</p><?php

			// Restore Product global in case this is shown inside a product post
			$eshopbox->setup_product_data( $post );
			...
			<p class="product product-variation" style="<?php echo $atts['style']; ?>">
				...
				$label 	= apply_filters('add_to_cart_text', __( 'Add to cart', 'eshopbox' ));
	...
	/**
	 * eshopbox_order_by_rating_post_clauses function.
	 *
	 * @access public
	 * @param mixed $args
	 * @return void
	...
	function related_products_shortcode( $atts ) {
		...
		eshopbox_related_products( $per_page, $columns, $orderby );
