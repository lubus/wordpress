<?php
/**
 * EshopBox Payment Gateways class
 *
...
class WC_Payment_Gateways {
    ...
    function init() {
    	...
    	$load_gateways = apply_filters( 'eshopbox_payment_gateways', array() );

		// Get order option
		$ordering 	= (array) get_option('eshopbox_gateway_order');
		$order_end 	= 999;
	...
	function get_available_payment_gateways() {
		...
		return apply_filters( 'eshopbox_available_payment_gateways', $_available_gateways );
	}
	...
	function process_admin_options() {
		...
		update_option( 'eshopbox_default_gateway', $default_gateway );
		update_option( 'eshopbox_gateway_order', $order );
	}
}