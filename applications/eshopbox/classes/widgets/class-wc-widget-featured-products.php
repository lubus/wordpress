...
class WC_Widget_Featured_Products extends WP_Widget {
	...
	function WC_Widget_Featured_Products() {
		...
		$this->woo_widget_cssclass = 'eshopbox widget_featured_products';
		$this->woo_widget_description = __( 'Display a list of featured products on your site.', 'eshopbox' );
		$this->woo_widget_idbase = 'eshopbox_featured_products';
		$this->woo_widget_name = __( 'EshopBox Featured Products', 'eshopbox' );
	...
	function widget($args, $instance) {
		...
		$title = apply_filters('widget_title', empty($instance['title']) ? __('Featured Products', 'eshopbox' ) : $instance['title'], $instance, $this->id_base);
