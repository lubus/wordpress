...
class WC_Widget_Best_Sellers extends WP_Widget {
	...
	function WC_Widget_Best_Sellers() {
		...
		$this->woo_widget_cssclass = 'eshopbox widget_best_sellers';
		$this->woo_widget_description = __( 'Display a list of your best selling products on your site.', 'eshopbox' );
		$this->woo_widget_idbase = 'eshopbox_best_sellers';
		$this->woo_widget_name = __( 'EshopBox Best Sellers', 'eshopbox' );
	...
	function widget( $args, $instance ) {
		...
		$title = apply_filters('widget_title', empty($instance['title']) ? __('Best Sellers', 'eshopbox' ) : $instance['title'], $instance, $this->id_base);
    	...
    	$query_args['meta_query'] = $eshopbox->query->get_meta_query();
	...
	function form( $instance ) {
		...
		<label for="<?php echo $this->get_field_id('hide_free'); ?>"><?php _e( 'Hide free products', 'eshopbox' ); ?></label></p>
