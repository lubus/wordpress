<?php
/**
 * Web interface for generating the EshopBox POT files
 *
 * @since 2.0
 * @package EshopBox
...
if ( ! empty( $_GET['generate'] ) ) {
	// Generate eshopbox and eshopbox-admin POT files
	$results = array();
...
<head>
	...
	<meta charset="utf-8">
	<title>EshopBox POT Generator</title>
	<style>
...
<body>
	...
	<h1>EshopBox <?php echo $makepot->eshopbox_version() ?> POT Generator</h1>
	...
	<p>This tool will (re)generate and overwrite the following EshopBox POT-files:</p>
