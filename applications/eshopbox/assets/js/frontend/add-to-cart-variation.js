    ...
    $.fn.wc_variation_form = function () {
        ...
        $form = this
				...
				.on( 'change', '.variations select', function( event ) {
					...
					$variation_form
						.trigger( 'eshopbox_variation_select_change' )
				...
				.on( 'focusin touchstart', '.variations select', function( event ) {
					...
					$variation_form
						.trigger( 'eshopbox_variation_select_focusin' )
				...
				.on( 'check_variations', function( event, exclude, focus ) {
			        ...
			        if ( all_set ) {
			        	...
			        	if ( variation ) {
			            	...
			            	alert( eshopbox_params.i18n_no_matching_variations_text );
				...
				.on( 'update_variation_values', function( event, variations ) {
					...
					$variation_form.trigger('eshopbox_update_variation_values');
