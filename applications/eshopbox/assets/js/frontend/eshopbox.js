jQuery(document).ready(function($) {
	...
	// Placeholder
	$('.eshopbox textarea[placeholder], .eshopbox-page textarea[placeholder], .eshopbox input[placeholder], .eshopbox-page input[placeholder]').placeholder();
	...
	var states_json = eshopbox_params.countries.replace(/&quot;/g, '"');
	...
	$('select.country_to_state').change(function(){
		...
		if (states[country]) {
			if (states[country].length == 0) {
				...
				$statebox.html( '<option value="">' + eshopbox_params.i18n_select_state_text + '</option>' + options);
