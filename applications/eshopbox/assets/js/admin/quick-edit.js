jQuery(document).ready(function(){
    jQuery('#the-list').on('click', '.editinline', function(){
		...
		var $wc_inline_data = jQuery('#eshopbox_inline_' + post_id );
    ...
    jQuery('#wpbody').on('click', '#doaction, #doaction2', function(){
        ...
        jQuery('#eshopbox-fields select').prop('selectedIndex',0);
        jQuery('#eshopbox-fields-bulk .inline-edit-group .alignright').hide();

	});

	jQuery('#wpbody').on('change', '#eshopbox-fields-bulk .inline-edit-group .change_to', function(){
