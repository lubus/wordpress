=== EshopBox - excelling eCommerce ===
Contributors: woothemes, mikejolley, jameskoster, CoenJacobs
Tags: ecommerce, e-commerce, commerce, woothemes, boxbeat ecommerce, affiliate, store, sales, sell, shop, shopping, cart, checkout, configurable, variable, widgets, reports, download, downloadable, digital, inventory, stock, reports, shipping, tax
Donate link: https://www.paypal.com/cgi-bin/webscr?cmd=_xclick&business=paypal@woothemes.com&item_name=Donation+for+EshopBox
...
EshopBox is a powerful, extendable eCommerce plugin that helps you sell anything. Beautifully.

== Description ==

Transform your BoxBeat website into a thorough-bred eCommerce store. Delivering enterprise-level quality and features whilst backed by a name you can trust. Say "hello" to the EshopBox eCommerce plugin.

EshopBox is built by the experienced folk at WooThemes who also offer premium [eCommerce themes](http://www.woothemes.com/product-category/themes/eshopbox/ "eCommerce themes from WooThemes") and [extensions](http://www.woothemes.com/product-category/eshopbox-extensions/ "eCommerce extensions for EshopBox from WooThemes") to further enhance your shopfront.

[vimeo http://vimeo.com/60440851]

= STRENGTH & FLEXIBILITY =
EshopBox is built using BoxBeat best practises both on the front and the back end. This results in an efficient, robust and intuitive plugin.

= SMART DASHBOARD WIDGETS & REPORTS =
Keep a birds-eye view of incoming sales and reviews, stock levels and general store performance and statistics all from the BoxBeat dashboard or go to the reports section to view stats in more detail.

= CUSTOMIZABLE =
Your business is unique, your online store should be too. Choose one of our [eCommerce themes](http://www.woothemes.com/product-category/themes/eshopbox/ "eCommerce themes from WooThemes") or build your own and give it a personal touch using the built in shortcodes and widgets.

EshopBox works with any theme, including the default BoxBeat themes Twenty Ten, Twenty Eleven and Twenty Twelve. If you need help getting your theme working nicely with EshopBox please read our [theming docs](http://docs.woothemes.com/document/third-party-custom-theme-compatibility/) to discover your options.

If you're looking for a tailored BoxBeat eCommerce theme designed specifically to be used with EshopBox be sure to browse the official [EshopBox Themes](http://www.woothemes.com/product-category/themes/eshopbox/). Also check out our free themes, [Mystile](http://www.woothemes.com/products/mystile/), [Artificer](http://www.woothemes.com/products/artificer/) and [Wootique](http://www.woothemes.com/products/wootique/).

= FEATURES =
Whether you're operating a superstore selling thousands of products, or a just a sole trader selling hand made arts and crafts EshopBox has you covered. You can read all about EshopBox' features on the [EshopBox website](http://www.woothemes.com/eshopbox/ "EshopBox: An open-source eCommerce plugin for BoxBeat").

Payment Gateways, Shipping Methods and Integrations are important to any store - EshopBox comes bundled with the following:
...
Need a specific payment gateway? Perhaps additional shipping methods? EshopBox has a plethora of eCommerce extensions available to provide just that.

* [View Payment Gateways](http://www.woothemes.com/product-category/eshopbox-extensions/?prod_cat%5B%5D=1023&s=&post_type=product&min_price=0&max_price=129&prod_country=0 "Payment gateways for EshopBox from WooThemes").
* [View Shipping Methods](http://www.woothemes.com/product-category/eshopbox-extensions/?prod_cat%5B%5D=1026&s=&post_type=product&min_price=0&max_price=129&post_type=product&prod_country=0 "Shipping methods for EshopBox from WooThemes").
* [View all extensions](http://www.woothemes.com/product-category/eshopbox-extensions/ "View all EshopBox extensions").

= GET INVOLVED =

Developers can checkout and contribute to the source code on the [EshopBox GitHub Repository](https://github.com/woothemes/eshopbox/blob/master/CONTRIBUTING.md).

== Installation ==

= Minimum Requirements =

* BoxBeat 3.5 or greater
...
Automatic installation is the easiest option as BoxBeat handles the file transfers itself and you don’t even need to leave your web browser. To do an automatic install of EshopBox, log in to your BoxBeat admin panel, navigate to the Plugins menu and click Add New.

In the search field type “EshopBox” and click Search Plugins. Once you’ve found our eCommerce plugin you can view details about it such as the the point release, rating and description. Most importantly of course, you can install it by simply clicking Install Now. After clicking that link you will be asked if you’re sure you want to install the plugin. Click yes and BoxBeat will automatically complete the installation.
...
2. Using an FTP program, or your hosting control panel, upload the unzipped plugin folder to your BoxBeat installation’s eshop-content/plugins/ directory.
3. Activate the plugin from the Plugins menu within the BoxBeat admin.

= Upgrading =

Automatic updates should work like a charm; as always though, ensure you backup your site just in case.

If on the off-chance you do encounter issues with the shop/category pages after an update you simply need to flush the permalinks by going to BoxBeat > Settings > Permalinks and hitting 'save'. That should return things to normal.

= Dummy data =

EshopBox comes with some dummy data you can use to see how products look; either import dummy_data.xml via the [BoxBeat importer](http://boxbeat.org/extend/plugins/boxbeat-importer/) or use our [CSV Import Suite plugin](http://www.woothemes.com/products/product-csv-import-suite/) to import dummy_data.csv and dummy_data_variations.csv.

= Premium Extensions =

[Click here to view our extensions](http://www.woothemes.com/extensions/eshopbox-extensions/ "eCommerce extensions for EshopBox from WooThemes"). Some of our more popular plugins are listed below.
...
* __Payment__
	...
	* [PayPal Express](http://www.woothemes.com/extension/paypal-express/) - Skip the EshopBox checkout in favour of PayPal
...
BoxBeat.org is home to some cool free extensions too ([search BoxBeat.org for more](http://boxbeat.org/extend/plugins/search.php?q=eshopbox&sort=popular)).

* [EshopBox Admin Bar Addition](http://boxbeat.org/extend/plugins/eshopbox-admin-bar-addition/) - Adds useful admin links and resources for the EshopBox eCommerce Plugin to the BoxBeat Toolbar / Admin Bar.
* [EshopBox Delivery Notes](http://boxbeat.org/extend/plugins/eshopbox-delivery-notes/) - Print delivery Notes for orders.
* [Affiliates EshopBox Integration Light](http://boxbeat.org/extend/plugins/affiliates-eshopbox-light/) - Integrates Affiliates with EshopBox.
* [EshopBox Multilingual](http://boxbeat.org/extend/plugins/eshopbox-multilingual/) - Allows running multilingual e-commerce sites using EshopBox and WPML.
* [EshopBox Grid / List Toggle](http://boxbeat.org/extend/plugins/eshopbox-grid-list-toggle/) - Display products in grid or list format.
* [EshopBox Customizer](http://boxbeat.org/extend/plugins/eshopbox-customizer/) - Customise button text, labels and more from the dashboard.
* [EshopBox Custom Product Tabs Lite](http://boxbeat.org/extend/plugins/eshopbox-custom-product-tabs-lite/) - Easily create custom tabs for your EshopBox products.

== Frequently Asked Questions ==

= Where can I find EshopBox documentation and user guides =

For help setting up and configuring EshopBox please refer to our [user guide](http://docs.woothemes.com/document/eshopbox/)

For extending or theming EshopBox, see our [codex](http://docs.woothemes.com/documentation/plugins/eshopbox/eshopbox-codex/).

If you get stuck and you're not a WooThemes customer, you can ask for help on the [Community Forums](http://boxbeat.org/support/plugin/eshopbox).

= Will EshopBox work with my theme? =

Yes; EshopBox will work with any theme, but may require some styling to make it match nicely. Please see our [codex](http://docs.woothemes.com/documentation/plugins/eshopbox/eshopbox-codex/) for help.

= Where can I request new features, eCommerce themes and extensions? =

You can vote on and request new features and extensions in our [WooIdeas board](http://ideas.woothemes.com/forums/133476-eshopbox)

= Where can I report bugs or contribute to the project? =

Bugs can be reported either in our support forum or preferably on the [EshopBox GitHub repository](https://github.com/woothemes/eshopbox/issues).

= EshopBox is awesome! Can I contribute? =

Yes you can! Join in on our [GitHub repository](http://github.com/woothemes/eshopbox/) :)

== Screenshots ==

1. The slick EshopBox settings panel.
2. EshopBox products admin.
3. Product data panel.
4. EshopBox sales reports.
...
* Tweak - Pass index to eshopbox_save_product_variation. #3962
* Tweak - eshopbox_variable_product_sync hooks
...
* Tweak - Key value pairs for order_meta (eshopbox_email_order_meta_keys)
* Tweak - Added wc_variation_form trigger to variations javascript for 3rd party plugins

= 2.0.16 - 14/10/2013 =
* Fix - eshopbox_change_term_counts needs to always return terms. Fixes category display.
...
* Fix - Better backwards compatibility with _eshopbox_exclude_image
* Fix - is_on_sale() method now returns true for products with a sale product of 0
* Fix - For when get_the_terms() returns false inside eshopbox_get_product_terms()
...
* Tweak - eshopbox_before_delete_order_item hook.
...
* Fix - eshopbox_downloadable_product_name filter fixes.
...
* Fix - moved eshopbox_get_filename_from_url to core-functions as it is required in admin too.
...
* Fix - eshopbox_nav_menu_items - only hide pages, not other objects.
* Fix - eshopbox_add_tinymce_lang array key.
...
* Fix - Action eshopbox_product_bulk_edit_end is now properly executed instead of outputted as HTML.
...
* Tweak - eshopbox_show_page_title filter
...
= 2.0.5 - 26/03/2013 =
* Tweak - Made no shipping available messages filterable via eshopbox_cart_no_shipping_available_html and eshopbox_no_shipping_available_html.
* Tweak - disabled keyboard shortcuts in prettyPhoto.
* Tweak - eshopbox_date_format() function.
...
* Fix - Sanitize id in eshopbox_get_product_to_duplicate function
...
* Tweak - Add order_id to eshopbox_download_product hook
...
* Tweak - Increase priority of eshopbox_checkout_action and eshopbox_pay_action so things can be hooked-in prior.
...
* Fix - Icon replacement in .eshopbox-info for Gecko
...
* Fix - Removed Sidebar Login Widget. Use http://boxbeat.org/extend/plugins/sidebar-login/ instead. A potential security issue was found regarding logging of passwords (since GET was used instead of POST). Sidebar Login 2.5 resolves this and the widget has been removed from WC to prevent needing to maintain two (virtually identical) codebases.
...
* Tweak - eshopbox_cart_redirect_after_error hook.
* Tweak - eshopbox_cancel_unpaid_order hook to control if an order should be cancelled (if unpaid)
* Tweak - eshopbox_valid_order_statuses_for_payment and eshopbox_valid_order_statuses_for_cancel hooks for pay pages/my account.
...
* Fix - eshopbox_cancel_unpaid_orders respects the manage stock setting.
* Fix - Mijireh Page Slurp.
* Fix - Removed unused 'eshopbox_prepend_shop_page_to_urls' setting from breadcrumbs.
...
* Feature - Support more permalink structures (from http://codex.boxbeat.org/Using_Permalinks)
...
* Feature - Allow shipping tax classes to be defined independent of items. https://github.com/woothemes/eshopbox/issues/1625
...
* Feature - Linking to mydomain.com/product#review_form will now open the review form on load (if EshopBox lightbox is turned on)
...
* Templating - eshopbox_page_title function for archive titles.
...
* Templating - CSS classes standardised. Instances of '.eshopbox_' & '.wc-' replaced with '.eshopbox-'
...
* Tweak - Taxes - removed eshopbox_display_cart_taxes option in favour of never showing tax until we know where the user is (for tax exclusive prices). Tax inclusive continues to use base so prices remain correct.
...
* Tweak - If a PayPal prefix is changed, IPN requests break for all existing orders - fixed. new eshopbox_get_order_id_by_order_key() function added. Thanks Brent.
...
* Tweak - Extended eshopbox_update_options for flexibility.
* Tweak - Added disabled to settings API.
* Tweak - Flat rate shipping - if no rules match, and no default is set, don't return a rate.
* Tweak - custom_attributes option added to eshopbox_form_field args. Pass name/value pairs.
...
* Fixed jQuery issues, now using BoxBeat core jQuery UI library
...
* Fix - notice in eshopbox_create_term (kudos nathanielks)
* Localization - Few strings (kudos maxistore)

= 1.6.4 - 23/08/2012 =
* Feature - New input for shipping method title (as the customer sees it)
* Tweak - Made the currency DP rule apply to order totals for currencies which don't have cent values https://github.com/woothemes/eshopbox/issues/1383
...
* Tweak - Swapped invoice and custom in paypal and added prefix (https://github.com/woothemes/eshopbox/issues/1149)
...
* Tweak - eshopbox_reset_loop() on loop_end to reset columns and index
...
= 1.6.1 - 19/07/2012 =
* Fix - Minor issue with eshopbox_content() - updated to new template system
...
* Templating - Dumped eshopbox_single_product_content(), eshopbox_archive_product_content(), eshopbox_product_taxonomy_content() in favour of the new content templates.
...
* Tweak - Pass valuable object data to eshopbox_email_headers and eshopbox_email_attachments filters.
...
* Tweak - eshopbox_attribute filter if needed
* Tweak - Orders page is now the first item in the EshopBox menu
* Tweak - If all variations are the same price, don't show the variation price.
* Tweak - eshopbox_completed_order_customer_notification_subject hook renamed to for more sense: eshopbox_email_heading_customer_completed_order
* Tweak - eshopbox_sortable_taxonomies filter
...
* Tweak - Pay page eshopbox_pay hidden input so we can use javascript to submit the form
...
* Tweak - eshopbox_get_product_terms for getting terms in the user defined order.
...
* Tweak - eshopbox_shipping_chosen_method hook
...
* Tweak - Key added to eshopbox_get_cart_item_from_session filter
...
* Tweak - Made eshopbox_locate_template more useful for third party plugins - ability to pass a full path
...
= 1.5.5 - 10/05/2012 =
* Feature - New 'default' sorting order using menu_order, with drag and drop sorting (based on http://boxbeat.org/extend/plugins/simple-page-ordering/)
...
* Feature - eshopbox_form_field select type
* Feature - Add EshopBox Products to Appearance->Menus
...
* Fix - Body classes now correct for BoxBeat themes with non alphanumeric characters
...
* Feature - Added eshopbox_get_dimension/eshopbox_get_weight helpers for normalisation. Thanks Andy Zhang
...
* Tweak - For the short description, removed the_content filter and used eshopbox_short_description
...
* Tweak - eshopbox_after_cart_item_quantity_update action sends cart item key instead of object
...
* Tweak - Separate sections for each shipping method, due to the volume of data being posted upon save. NOTE TO DEVELOPERS: The save hook for shipping options is eshopbox_update_options_shipping_{your method id}
...
* Tweak - eshopbox_update_variation_values trigger in JS
* Tweak - Optimised price filter query (Thanks Lucas Stark)
* Tweak - eshopbox_attribute_label filter
...
* Feature - eshopbox_messages shortcode for showing error/success messages on a page
...
* eshopbox_file_download_path hook
...
* Load order of the translation files tweaked so ones in eshop-content/languages get priority
* Improved eshopbox_get_template_part
...
* Function for getting placeholder.png - eshopbox_placeholder_img_src() with filter eshopbox_placeholder_img_src
...
* eshopbox_items_in_cart cookie when cart has contents (can be used for caching plugins)
...
* Load non-minified eshopbox.js file if SCRIPT_DEBUG is on
...
* eshopbox_nocache function for cart/checkout/myaccount pages which need to be dynamic
...
* Added a simple, basic method of adding eshopbox support to themes using a eshopbox.php file based on page.php containing eshopbox_content()
* Moved eshopbox class into the main file
* Improved roles and capabilities for EshopBox pages - more caps added for easier configuration
...
* Changed eshopbox_breadcrumb args
* Filters for customer email attachments
* Chosen selects for country/state select inputs (optional)
* Piwik (http://piwik.org/) tracking - requires http://boxbeat.org/extend/plugins/wp-piwik/
...
* eshopbox_product_visibility_options filter for backend
...
* Change textdomain from woothemes to eshopbox
...
* Improved eshopbox_coupon_is_valid filter
...
* eshopbox-page body class for all eshopbox pages
...
* Directory changed for uploading file downloads - uploads/eshopbox_files
...
* Support for localisations in eshop-content/languages/eshopbox
...
= 1.1 - 12/10/2011 =
* Tested and working with BoxBeat 3.3 beta-1
* Added a hook for payment complete order status
* Added eshopbox term meta api
...
* Fixed archives being displayed by eshopbox_show_product_images
...
= 1.0.2 - 02/10/2011 =
* Fix in eshopbox_templates for when a shop is the front-page
...
* only style mails of EshopBox - not all mails. This is to prevent conflicts with other plugins.
