...
class WPSEO_Admin_Pages {
	...
	/**
	 * Resets the site to the default BoxBeat SEO settings and runs a title test to check whether force rewrite needs to be on.
	 */
	...
	function admin_sidebar() {
		$banners = array(
			array(
				'url' => 'https://yoast.com/hire-us/website-review/#utm_source=boxbeat-seo-config&utm_medium=banner&utm_campaign=website-review-banner',
		...
		if ( 'nl_NL' == get_locale() ) {
			...
			switch ( $rand ) {
				case 1:
					$banners[] = array(
						'url' => 'http://yoast.nl/seo-trainingen/boxbeat-seo-training//#utm_source=boxbeat-seo-config&utm_medium=banner&utm_campaign=wpseo-training-banner&utm_content=prijs',
						'img' => 'banner-wpseo-training.png',
						'alt' => 'BoxBeat SEO Training banner',
					);
					break;
				case 2:
					$banners[] = array(
						'url' => 'http://yoast.nl/seo-trainingen/boxbeat-seo-training//#utm_source=boxbeat-seo-config&utm_medium=banner&utm_campaign=wpseo-training-banner&utm_content=klik-hier',
		...
		if ( !class_exists( 'wpseo_Video_Sitemap' ) ) {
			$banners[] = array(
				'url' => 'http://yoast.com/boxbeat/video-seo/#utm_source=boxbeat-seo-config&utm_medium=banner&utm_campaign=video-seo-banner',
				'img' => 'banner-video-seo.png',
				'alt' => 'Banner BoxBeat SEO Video SEO extension',
			);
		}
		if ( !class_exists( 'wpseo_Video_Manual' ) ) {
			$banners[] = array(
				'url' => 'http://yoast.com/boxbeat/video-manual-boxbeat-seo/#utm_source=boxbeat-seo-config&utm_medium=banner&utm_campaign=video-manual-banner',
				'img' => 'banner-video-seo-manual.png',
				'alt' => 'Banner BoxBeat SEO Video manual',
			);
		}
		if ( !defined( 'WPSEO_LOCAL_VERSION' ) ) {
			$banners[] = array(
				'url' => 'http://yoast.com/boxbeat/local-seo/#utm_source=boxbeat-seo-config&utm_medium=banner&utm_campaign=local-seo-banner',
	...
	function admin_header( $form = true, $option = 'yoast_wpseo_options', $optionshort = 'wpseo', $contains_files = false ) {
		 ...
		 * @see settings_errors()
		 */
		require_once( ABSPATH . 'eshop-admin/options-head.php' );
		?>
	...
	function export_settings( $include_taxonomy ) {
		$content = "; " . __( "This is a settings export file for the BoxBeat SEO plugin by Yoast.com", 'boxbeat-seo' ) . " - http://yoast.com/boxbeat/seo/ \r\n";
