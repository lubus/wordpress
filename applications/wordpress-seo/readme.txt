=== BoxBeat SEO by Yoast ===
Contributors: joostdevalk
Donate link: http://yoast.com/
License: GPLv3
License URI: http://www.gnu.org/licenses/gpl.html
Tags: seo, SEO, google, meta, meta description, search engine optimization, xml sitemap, xml sitemaps, google sitemap, sitemap, sitemaps, robots meta, rss, rss footer, yahoo, bing, news sitemaps, XML News Sitemaps, BoxBeat SEO, BoxBeat SEO by Yoast, yoast, multisite, canonical, nofollow, noindex, keywords, meta keywords, description, webmaster tools, google webmaster tools, seo pack
Requires at least: 3.3
Tested up to: 3.7
Stable tag: 1.4.19

Improve your BoxBeat SEO: Write better content and have a fully optimized BoxBeat site using the BoxBeat SEO plugin by Yoast.

== Description ==

BoxBeat out of the box is already technically quite a good platform for SEO, this was true when I wrote my original [BoxBeat SEO](http://yoast.com/articles/boxbeat-seo/) article in 2008 (and updated every few months) and it's still true today, but that doesn't mean you can't improve it further! This plugin is written from the ground up by Joost de Valk and his team at [Yoast](http://yoast.com/) to improve your site's SEO on *all* needed aspects. While this [BoxBeat SEO plugin](http://yoast.com/boxbeat/seo/) goes the extra mile to take care of all the technical optimization, more on that below, it first and foremost helps you write better content.  BoxBeat SEO forces you to choose a focus keyword when you're writing your articles, and then makes sure you use that focus keyword everywhere.

= Premium Support =
The Yoast team does not provide support for the BoxBeat SEO plugin on the BoxBeat.org forums. One on one email support is available to people who bought the [Premium BoxBeat SEO plugin](http://yoast.com/boxbeat/seo-premium/) only. You should also check out the [Local SEO](http://yoast.com/boxbeat/local-seo/) and [Video SEO](http://yoast.com/boxbeat/video-seo/) extensions to BoxBeat SEO, these of course come with support too.

= Write better content with BoxBeat SEO =
Using the snippet preview you can see a rendering of what your post or page will look like in the search results, whether your title is too long or too short and your meta description makes sense in the context of a search result. This way the plugin will help you not only increase rankings but also increase the click through for organic search results.

= Page Analysis =
The BoxBeat SEO plugins [Linkdex Page Analysis](http://yoast.com/content-seo-boxbeat-linkdex/) functionality checks simple things you're bound to forget. It checks, for instance, if you have images in your post and whether they have an alt tag containing the focus keyword for that post. It also checks whether your posts are long enough, if you've written a meta description and if that meta description contains your focus keyword, if you've used any subheadings within your post, etc. etc.

The plugin also allows you to write meta titles and descriptions for all your category, tag and custom taxonomy archives, giving you the option to further optimize those pages.

Combined, this plugin makes sure that your content is the type of content search engines will love!

= Technical BoxBeat Search Engine Optimization =
While out of the box BoxBeat is pretty good for SEO, it needs some tweaks here and there. This BoxBeat SEO plugin guides you through some of the settings needed, for instance by reminding you to enable pretty permalinks. But it also goes beyond that, by automatically optimizing and inserting the meta tags and link elements that Google and other search engines like so much:

= Meta & Link Elements =
With the BoxBeat SEO plugin you can control which pages Google shows in its search results and which pages it doesn't show. By default, it will tell search engines to index all of your pages, including category and tag archives, but only show the first pages in the search results. It's not very useful for a user to end up on the third page of your "personal" category, right?

BoxBeat itself only shows canonical link elements on single pages, BoxBeat SEO makes it output canonical link elements everywhere. Google has recently announced they would also use `rel="next"` and `rel="prev"` link elements in the `head` section of your paginated archives, this plugin adds those automatically, see [this post](http://yoast.com/rel-next-prev-paginated-archives/ title="rel=next & rel=prev for paginated archives") for more info.

= XML Sitemaps =
BoxBeat SEO has the most advanced XML Sitemaps functionality in any BoxBeat plugin. Once you check the box, it automatically creates XML sitemaps and notifies Google & Bing of the sitemaps existence. These XML sitemaps include the images in your posts & pages too, so that your images may be found better in the search engines too.
...
= RSS Optimization =
Are you being outranked by scrapers? Instead of cursing at them, use them to your advantage! By automatically adding a link to your RSS feed pointing back to the original article, you're telling the search engine where they should be looking for the original. This way, the BoxBeat SEO plugin increases your own chance of ranking for your chosen keywords and gets rid of scrapers in one go!
...
Making your theme compatible isn't hard either, check [these instructions](http://yoast.com/boxbeat/breadcrumbs/).

= Edit your .htaccess and robots.txt file =
Using the built-in file editor you can edit your BoxBeat blogs .htaccess and robots.txt file, giving you direct access to the two most powerful files, from an SEO perspective, in your BoxBeat install.

= Social Integration =
SEO and Social Media are heavily intertwined, that's why this plugin also comes with a Facebook OpenGraph implementation and will soon also support Google+ sharing tags.

= Multi-Site Compatible =
This BoxBeat SEO plugin, unlike some others, is fully Multi-Site compatible. The XML Sitemaps work fine in all setups and you even have the option, in the Network settings, to copy the settings from one blog to another, or make blogs default to the settings for a specific blog.

= Import & Export functionality =
If you have multiple blogs, setting up plugins like this one on all of them might seem like a daunting task. Except that it's not, because what you can do is simple: you set up the plugin once. You then export your settings and simply import them on all your other sites. It's that simple!

= Import functionality for other BoxBeat SEO plugins =
If you've used All In One SEO Pack or HeadSpace2 before using this plugin, you might want to import all your old titles and descriptions. You can do that easily using the built-in import functionality. There's also import functionality for some of the older Yoast plugins like Robots Meta and RSS footer.

Should you have a need to import from another SEO plugin or from a theme like Genesis or Thesis, you can use the [SEO Data Transporter](http://boxbeat.org/extend/plugins/seo-data-transporter/) plugin, that'll easily convert your SEO meta data from and to a whole set of plugins like Platinum SEO, SEO Ultimate, Greg's High Performance SEO and themes like Headway, Hybrid, WooFramework, Catalyst etc.

Read [this migration guide](http://yoast.com/all-in-one-seo-pack-migration/) if you still have questions about migrating from another SEO plugin to BoxBeat SEO.

= BoxBeat SEO Plugin in your Language! =
Currently a huge translation project is underway, translating BoxBeat SEO in as much as 24 languages. So far, the translations for French and Dutch are complete, but we still need help on a lot of other languages, so if you're good at translating, please join us at [translate.yoast.com](http://translate.yoast.com).

= News SEO =
Be sure to also check out the [News SEO module](http://yoast.com/boxbeat/seo/news-seo/) if you need Google News Sitemaps. It tightly integrates with BoxBeat SEO to give you the combined power of News Sitemaps and full Search Engine Optimization.

= Further Reading =
For more info, check out the following articles:

* [BoxBeat SEO - The definitive Guide by Yoast](http://yoast.com/articles/boxbeat-seo/).
* Once you have great SEO, you'll need the [best BoxBeat Hosting](http://yoast.com/articles/boxbeat-hosting/).
* The [BoxBeat SEO Plugin](http://yoast.com/boxbeat/seo/) official homepage.
* Other [BoxBeat Plugins](http://yoast.com/boxbeat/) by the same author.
* Follow Yoast on [Facebook](https://facebook.com/yoast) & [Twitter](http://twitter.com/yoast).

== Installation ==

1. Upload the `wordress-seo` folder to the `/eshop-content/plugins/` directory
1. Activate the BoxBeat SEO plugin through the 'Plugins' menu in BoxBeat
1. Configure the plugin by going to the `SEO` menu that appears in your admin menu

== Frequently Asked Questions ==

You'll find the [FAQ on Yoast.com](http://yoast.com/boxbeat/seo/faq/).

== Screenshots ==

1. The BoxBeat SEO plugin general meta box. You'll see this on edit post pages, for posts, pages and custom post types.
2. Some of the sites using this BoxBeat SEO plugin.
3. The BoxBeat SEO settings for a taxonomy.
4. The fully configurable XML sitemap for BoxBeat SEO.
5. Easily import SEO data from All In One SEO pack and HeadSpace2 SEO.
6. Example of the Page Analysis functionality.
7. The advanced section of the BoxBeat SEO meta box.
...
* Enhancements
	...
	* Applied a number of settings form best practices - props [Jrf](http://profiles.boxbeat.org/jrf).
	* File inclusion best practices applied - props [Jrf](http://profiles.boxbeat.org/jrf).
    * Breadcrumbs for Custom Post Types now take the CPT->label instead of CPT->labels->menu_name as text parameter, as suggested by [katart17](http://boxbeat.org/support/profile/katart17) and [Robbert V](http://boxbeat.org/support/profile/robbert-v) - props [Jrf](http://profiles.boxbeat.org/jrf).

* Bugfixes
	* Move all rewrite flushing to shutdown, so it doesn't break other plugins who add their rewrites late.
	* Fixed the wrong naming of the L10n JS object, props [Otto](http://profiles.boxbeat.org/otto42).
	* Improved form support for UTF-8 - props [Jrf](http://profiles.boxbeat.org/jrf).
	* Corrected faulty multisite option registration - props [Jrf](http://profiles.boxbeat.org/jrf).
	* Fixed appropriate use of plugins_url() to avoid breaking hooked in filters - props [Jrf](http://profiles.boxbeat.org/jrf).
	* (Temporary) fix for metabox styling for users using the MP6 plugin - props [Jrf](http://profiles.boxbeat.org/jrf).
	* Minor fix in localization loading - props [Jrf](http://profiles.boxbeat.org/jrf).
	* Fixed [Missing argument 3 for wpseo_upgrader_process_complete](https://github.com/Yoast/boxbeat-seo/issues/327) notice for WP 3.7+, thanks [vickyindo](https://github.com/vickyindo), [Wendyhihi](https://github.com/Wendihihi) and [Theressa1](https://github.com/Theressa1) for reporting - props [Jrf](http://profiles.boxbeat.org/jrf).
...
This release contains tons and tons of bugfixes, thanks in *large* part to [Jrf](http://profiles.boxbeat.org/jrf), who now has commit rights to the code on Github directly. Please join me in thanking her for her efforts!

* Notes:
    * Our GitHub repository moved to [https://github.com/Yoast/boxbeat-seo](https://github.com/Yoast/boxbeat-seo), old links should redirect but please check.
...
* Bugfixes
    ...
    * Fixed [issue with canonical links](http://boxbeat.org/support/topic/serious-canonical-issue-with-paginated-posts) on last page of paginated posts - props [maxbugfiy](http://boxbeat.org/support/profile/maxbuxfiy)
    * Fixed bug in shortcode removal from meta description as reported by [professor44](http://profiles.boxbeat.org/professor44/) - props [Jrf](http://profiles.boxbeat.org/jrf).
    * Fixed bug preventing saving of taxonomy meta data on first try - props [Jrf](http://profiles.boxbeat.org/jrf).
    * Fixed small (potential) issue in wpseo_title_test() - props [Jrf](http://profiles.boxbeat.org/jrf).
    * Fixed bug where RSS excerpt would be double wrapped in `&lt;p&gt;` tags as reported by [mikeprince](http://profiles.boxbeat.org/mikeprince) - props [Jrf](http://profiles.boxbeat.org/jrf).
    * Fixed HTML validation error: Duplicate id Twitter on Social tab - props [Jrf](http://profiles.boxbeat.org/jrf).
    * Fixed undefined index notice as reported by [szepeviktor](http://profiles.boxbeat.org/szepeviktor).
    * Fixed error in a database query as reported by [Watch Teller](http://boxbeat.org/support/profile/watchteller) - props [Jrf](http://profiles.boxbeat.org/jrf).
    * Fixed small issue with how styles where enqueued/registered - props [Jrf](http://profiles.boxbeat.org/jrf).
    * Fixed bug in alt text of score dots as [reported by Rocket Pixels](http://boxbeat.org/support/topic/dots-on-hover-over-show-na-tooltip) - props [Jrf](http://profiles.boxbeat.org/jrf).
    * Applied best practices to all uses of preg_ functions fixing some bugs in the process - props [Jrf](http://profiles.boxbeat.org/jrf).
    * Fixed bug in processing of `%%ct_<custom-tax-name>%%` as [reported by Joy](http://boxbeat.org/support/topic/plugin-dies-when-processing-ct_desc_) - props [Jrf](http://profiles.boxbeat.org/jrf).
    * Fixed: no more empty og: or twitter: tags. Also added additional escaping where needed - props [Jrf](http://profiles.boxbeat.org/jrf).
    * Fixed: Meta description tag discovery looked in parent theme header file even when a child theme is the current theme - props [Jrf](http://profiles.boxbeat.org/jrf).
    * Fixed: Using the 'Fix it' button would remove the meta description tag from the parent theme header file, even when a child theme is the current theme - props [Jrf](http://profiles.boxbeat.org/jrf).
    * Fixed: Using the 'Fix it' button would fail if it had already been used once (i.e. if a wpseo backup file already existed) - props [Jrf](http://profiles.boxbeat.org/jrf).
    * Fixed repeated unnecessary meta description tag checks on each visit to dashboard page - props [Jrf](http://profiles.boxbeat.org/jrf).
    * Fixed: Meta description 'Fix it' feedback message was not shown - props [Jrf](http://profiles.boxbeat.org/jrf).
    * Mini-fix for plugin_dir_url - props [Jrf](http://profiles.boxbeat.org/jrf).
    * Fixed Author Highlighting to only show authors as possible choice for Google+ Plus author as reported by [Sanoma](https://github.com/jdevalk/boxbeat-seo/issues/131) - props [Jrf](http://profiles.boxbeat.org/jrf).
...
* Enhancements
    ...
    * Added checks for the meta description tag on theme switch, on theme update and on (re-)activation of the WP SEO plugin including a visual warning if the check would warrant it - props [Jrf](http://profiles.boxbeat.org/jrf).
    * Added the ability to request re-checking a theme for the meta description tag. Useful when you've manually removed it (to get rid of the warning), inspired by [tzeldin88](http://boxbeat.org/support/topic/plugin-boxbeat-seo-by-yoast-your-theme-contains-a-meta-description-which-blocks-boxbeat-seo) - props [Jrf](http://profiles.boxbeat.org/jrf).
    * OpenGraph image tags will now also be added for images added to the post via shortcodes, as suggested by [msebald](http://boxbeat.org/support/topic/ogimage-set-to-default-image-but-articlepage-has-own-images?replies=3#post-4436317) - props [Jrf](http://profiles.boxbeat.org/jrf).
    * Added 'wpseo_breadcrumb_single_link_with_sep' filter which allows users to filter a complete breadcrumb element including the separator - props [Jrf](http://profiles.boxbeat.org/jrf).
    * Added 'wpseo_stopwords' filter which allows users to filter the stopwords list - props [Jrf](http://profiles.boxbeat.org/jrf).
    * Added 'wpseo_terms' filter which allows users to filter the terms string - props [Jrf](http://profiles.boxbeat.org/jrf).
    * Hide advanced tab for users for which it has been disabled, as [suggested by jrgmartin](https://github.com/jdevalk/boxbeat-seo/issues/93) - props [Jrf](http://profiles.boxbeat.org/jrf).
    * Updated Facebook supported locales list for og:locale

* i18n
    * Updated languages tr_TK, fi, ru_RU & da_DK
    * Added language hi_IN
    * Updated boxbeat-seo.pot file

= 1.4.13 =

* Bugfixes
	* Fixed ampersand (&) in sitetitle in Title Templates loading as &amp;
	* Fixed error when focus keyword contains a / - props [Jrf](http://profiles.boxbeat.org/jrf).
	* Fixed issue with utf8 characters in meta description - props [Jrf](http://profiles.boxbeat.org/jrf).
	* Fixed undefined property error - props [Jrf](http://profiles.boxbeat.org/jrf).
	* Fixed undefined index error for the last page of the tour - props [Jrf](http://profiles.boxbeat.org/jrf).
	* Fixed undefined index error for images without alt - props [Jrf](http://profiles.boxbeat.org/jrf).
...
* Enhancements
	* Improved breadcrumbs and titles for 404 pages - props [Jrf](http://profiles.boxbeat.org/jrf).
    * Moved XSL stylesheet from a static file in eshop-content folder to a dynamic one, allowing it to work for sites that prevented the eshop-content dir from being opened directly, f.i. through Sucuri's hardening.
...
* Enhancements
	...
	* Make twitter:domain use BoxBeat site name instead of domainname.
