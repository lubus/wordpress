...
class WPSEO_Sitemaps {
	...
	function build_post_type_map( $post_type ) {
		...
		while ( $total > $offset ) {
			...
			// Optimized query per this thread: http://boxbeat.org/support/topic/plugin-boxbeat-seo-by-yoast-performance-suggestion
	...
	function output() {
		...
		echo $this->sitemap;
		echo "\n" . '<!-- XML Sitemap generated by Yoast BoxBeat SEO -->';
