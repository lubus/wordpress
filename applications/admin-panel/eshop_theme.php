...
Description:Admin Theme By eshopbox.com. just activate to use this admin template
Version: 1.0
...
function wooadmin_my_admin_theme_style() {
    wp_enqueue_style('my-admin-theme', plugins_url('eshop-admin.css', __FILE__));
}
...
function wooadmin_wrap_menu_div_wpse_19814()
{
    ...
    <script type="text/javascript">
        ...
        {
            $('#eshop-admin-bar-site-name').each(function()
            {
             ...
             $('#eshop-admin-bar-comments, #eshop-admin-bar-new-content').each(function()
            {
                $(this).html( '' );
            });
        });
...
// Another Method to add custom menu in boxbeat header
...
function wooadmin_eshop_admin_logo()
{
    ...
    <script type="text/javascript">
        jQuery(document).ready(function($)
        {
            $('#eshop-admin-bar-wp-logo').each(function()
            {
                old_value = $(this).html();
                $(this).html( '<a class="ab-item" aria-haspopup="true" href="<?php echo site_url(); ?>/eshop-admin" title="Go to Eshopbox"><span class="ab-icon"></span></a>');
            });
        });
    </script>
    <?php
...
{   $user = wp_get_current_user();
    if($user->roles[0] !='orderadmin'){
    ?>
    <script type="text/javascript">
        jQuery(document).ready(function($)
        {
            $('#eshop-admin-bar-top-secondary').each(function()
            {
                old_value = $(this).html();
                $(this).html( '<li id="eshop-admin-bar-logout" class="menupop"><a class="ab-item" aria-haspopup="true" href="<?php echo wp_logout_url( home_url() ); ?>/eshop-admin" title="Logout"><span class="ab-logout ab-icon icon"></span>Logout</a></li>          <li id="eshop-admin-bar-settings" class="menupop"><a class="ab-item" aria-haspopup="true" href="<?php echo site_url(); ?>/eshop-admin/admin.php?page=eshopbox_settings"><span class="ab-settings ab-icon icon"></span>Settings</a></li><li id="eshop-admin-bar-messages" class="menupop"><a class="ab-item" aria-haspopup="true" href="<?php echo site_url(); ?>/eshop-admin/edit-comments.php"><span class="ab-message ab-icon icon"></span>Messages</a></li>');
            });
    ...
    <script type="text/javascript">
        jQuery(document).ready(function($)
        {
            ...
            {
                old_value = $(this).html();
                $(this).html( '<li id="eshop-admin-bar-logout" class="menupop"><a class="ab-item" aria-haspopup="true" href="<?php echo wp_logout_url( home_url() ); ?>/eshop-admin" title="Logout"><span class="ab-logout ab-icon icon"></span>Logout</a></li> ');
            });
        });
    </script>
   <?php }
...
// CUSTOMIZE ADMIN MENU ORDER
   function wooadmin_custom_menu_order($menu_ord) {
       ...
       return array(
        ...
        'plugins.php', //plugin
        'admin.php?page=eshopbox-manifest',//manifest
    );
   }
   add_filter('menu_order', 'wooadmin_custom_menu_order');
// CUSTOMIZE ADMIN MENU ORDER

//Replaces eshop-admin menu item names
   // echo admin_url()."admin.php?page=cat_reports";
   if ( isset($_GET['page']) ) {
    $plugin_page = stripslashes($_GET['page']);
    //echo $plugin_page;
   if($plugin_page=='eshopbox_reports' && $plugin_page=='eshopbox_reports'){
    //echo $plugin_page;
   }}
   else{
...
function wooadmin_eshop_seperator_text()
{
    ...
    <script type="text/javascript">
        jQuery(document).ready(function($)
        {
            ...
            {
                old_value = $(this).html();
                 $(this).html( '<a href="http://localhost/storeadmin/eshopbox/eshop-admin/users.php?orderby=login&amp;order=asc"><span>Email</span><span class="sorting-indicator"></span></a>');
            });
            ...
            $('#toplevel_page_eshopbox').each(function()
            {
                old_value = $(this).html();
                 $(this).html( '');
            });
            ...
            $('#eshopbox_extensions').each(function()
            {
                old_value = $(this).html();
                $(this).html( '');
            });
			...
			$('.eshopbox_page_eshopbox_settings .nav-tab-wrapper.woo-nav-tab-wrapper').each(function()
            {
                old_value = $(this).html();
                $(this).html( '');
            });
			$('.icon32-eshopbox-settings').each(function()
            {
                old_value = $(this).html();
                $(this).html( '');
            });
...
function wooadmin_renameuser() {
    ...
    // to override SEO menu to Seo Suite
           // add_menu_page( __( 'BoxBeat SEO Configuration', 'boxbeat-seo' ), __( 'SEO Suite', 'boxbeat-seo' ), 'manage_options', 'wpseo_dashboard', array( $this, 'config_page' ), WPSEO_URL . 'images/yoast-icon.png' );
            // to override SEO menu to Seo Suite
}
...
function wooadmin_remove_unused_menu() {
   ...
   //  remove_submenu_page('edit.php?post_type=shop_order','?page=eshopbox_reports'); // Remove the Tools Menu

    // remove_menu_page('admin.php?page=eshopbox_reports'); // Remove the Tools Menu

    // remove_menu_page('edit.php?post_type=shop_coupon'); // Remove the Tools Menu

    // remove_menu_page('admin.php?page=eshopbox_settings'); // Remove the Tools Menu
...
function wooadmin_dasboard_sub_menu() {
    ...
    $menu[61] = array( __('Widgets'), 'read', 'widgets.php', '', 'menu-top menu-top-first menu-icon-coupon', 'menu-dashboard', 'none' );

    $menu[62] = array( __('Menus'), 'read', 'nav-menus.php', '', 'menu-top menu-top-first menu-icon-coupon', 'menu-dashboard', 'none' );

    $menu[63] = array( __('Header'), 'read', 'themes.php?page=custom-header', '', 'menu-top menu-top-first menu-icon-coupon', 'menu-dashboard', 'none' );

    $menu[64] = array( __('Background'), 'read', 'themes.php?page=custom-background', '', 'menu-top menu-top-first menu-icon-coupon', 'menu-dashboard', 'none' );

    $menu[66] = array( __('Mailchimp Setup'), 'read', 'options-general.php?page=mailchimpSF_options', '', 'menu-top menu-top-first menu-icon-coupon', 'menu-dashboard', 'none' );
   // $menu[70] = array( __('Manifest'), 'read', 'admin.php?page=eshopbox-manifest', '', 'menu-top menu-top-first menu-icon-coupon', 'menu-dashboard', 'none' );
   // $menu[72] = array( __('COD pincodes'), 'read', 'admin.php?page=wc-checkout-cod-pincodes', '', 'menu-top menu-top-first menu-icon-coupon', 'menu-dashboard', 'none' );
   ...
   //$menu[4] = array( '', 'read', 'separator1', '', 'wp-menu-separator' );
    ...
    $submenu[ 'index.php' ][1] = array( __('Reports'), 'read', 'admin.php?page=eshopbox_reports' );
    //$submenu[ 'users.php' ][1] = array( __('User Role Editor'), 'read', 'users.php?page=user-role-editor.php' );
    $submenu['edit.php?post_type=product'][1 ]= array( __('CSV Import Suite'), 'read', 'admin.php?page=eshopbox_csv_import_suite' );
...
if($_GET['page']!='eshopbox_settings' && $_GET['page']!='eshopbox_settings'){    // echo 'test';
}
...
//Remove sub level admin menus
    ...
    remove_submenu_page( 'edit.php?post_type=shop_order', 'eshopbox_reports' );

    remove_submenu_page( 'edit.php?post_type=shop_order', 'edit.php?post_type=shop_coupon' );

    remove_submenu_page( 'edit.php?post_type=shop_order', 'eshopbox_settings' );

    remove_submenu_page( 'edit.php?post_type=shop_order', 'eshopbox_status' );

    remove_submenu_page( 'index.php', 'admin.php?page=eshopbox_reports' );
    ...
    $menu[6] = array( __('General'), 'read', 'admin.php?page=eshopbox_settings&tab=general', '', 'menu-top menu-top-first menu-icon-dashboard', 'menu-dashboard', 'none' );

    $menu[7] = array( __('Catalogue'), 'read', 'admin.php?page=eshopbox_settings&tab=catalog', '', 'menu-top menu-top-first menu-icon-catalogue', 'menu-dashboard', 'none' );

    //$menu[8] = array( __('Pages'), 'read', 'admin.php?page=eshopbox_settings&tab=pages', '', 'menu-top menu-top-first menu-icon-page', 'menu-dashboard', 'none' );
   // $menu[8] = array( __('Manifest'), 'read', 'admin.php?page=eshopbox-manifest', '', 'menu-top menu-top-first menu-icon-page', 'menu-dashboard', 'none' );



    $menu[9] = array( __('Inventory'), 'read', 'admin.php?page=eshopbox_settings&tab=inventory', '', 'menu-top menu-top-first menu-icon-post', 'menu-dashboard', 'none' );

    $menu[19] = array( __('Tax'), 'read', 'admin.php?page=eshopbox_settings&tab=tax', '', 'menu-top menu-top-first menu-icon-tax', 'menu-dashboard', 'none' );

    $menu[40] = array( __('Shipping'), 'read', 'admin.php?page=eshopbox_settings&tab=shipping', '', 'menu-top menu-top-first menu-icon-shipping', 'menu-dashboard', 'none' );

    $menu[41] = array( __('Payment Gateways'), 'read', 'admin.php?page=eshopbox_settings&tab=payment_gateways', '', 'menu-top menu-top-first menu-icon-payment', 'menu-dashboard', 'none' );

    $menu[42] = array( __('Emails'), 'read', 'admin.php?page=eshopbox_settings&tab=email', '', 'menu-top menu-top-first menu-icon-mail', 'menu-dashboard', 'none' );

    $menu[43] = array( __('Integration'), 'read', 'admin.php?page=eshopbox_settings&tab=integration', '', 'menu-top menu-top-first menu-icon-integration', 'menu-dashboard', 'none' );

    $menu[44] = array( __('PIP Settings'), 'read', 'admin.php?page=eshopbox_pip', '', 'menu-top menu-top-first menu-icon-integration', 'menu-dash', 'none' );
...
//     $admin_title = sprintf( __( '%1$s &#8212; BoxBeat' ), $title );

// else

//     $admin_title = sprintf( __( '%1$s &lsaquo; %2$s &#8212; BoxBeat' ), $title, $admin_title );
...
// title of admin pages boxbeat remove_dashboard_widgets
...
// Remove plugin update notification
 ...
 // Hide the BoxBeat Upgrade Message in the Dashboard
...
function wooadmin_exclude_this_page( $query ) {
   ...
   //  if( 'edit-pages.php' == $pagenow )
    ...
    // BoxBeat 3.0
    $bal = get_option(' eshopbox_myaccount_page_id ');
    $bal1 = get_option('eshopbox_shop_page_id');
    $bal2 = get_option('eshopbox_cart_page_id');
    $bal3 = get_option(' eshopbox_pay_page_id ');
    $bal4 = get_option(' eshopbox_thanks_page_id ');
    $bal5 = get_option(' eshopbox_edit_address_page_id ');
    $bal6 = get_option(' eshopbox_view_order_page_id ');
    $bal7 = get_option(' eshopbox_terms_page_id ');
    $bal8 = get_option('eshopbox_checkout_page_id');
    $bal9 = get_option('eshopbox_change_password_page_id');
    $bal10 = get_option('eshopbox_lost_password_page_id');
    $bal11 = get_option('eshopbox_logout_page_id');
...
// to hide boxbeat version like we see meta ="generator" and boxbeat version in view code
...
// romove welcome message from boxbeat dashboard
...
// Force one column layout page in screen options in boxbeat admin page
...
*/
remove_action('admin_menu', 'eshopbox_admin_menu_after', 50);
function wooadmin_eshopbox_admin_menu_after1() {
    $settings_page = add_submenu_page( 'eshopbox', __( 'Eshopbox Settings Page', 'eshopbox' ),  __( 'Settings', 'eshopbox' ) , 'manage_eshopbox', 'eshopbox_settings', 'eshopbox_settings_page');
...
add_action('admin_menu', 'wooadmin_eshopbox_admin_menu_after1', 50);
...
// To hide eshopbox meta tag in head
...
// remove junk from admin panel for order admin
...
//******************order admin code starts here***************************


// remove unwanted dashboard widgets for order admin
function custom_dashboard_for_orderadmin() {
    $user = wp_get_current_user();
    if($user->roles[0]=='orderadmin'){
        global $menu,$submenu;
        remove_menu_page('edit.php');//remove blog menu page
        remove_menu_page('Catalogue');//remove catalogue menu page
        remove_menu_page('wpcf7');//remove contact form 7  page
        remove_menu_page('widgets.php');//remove widgets page
        remove_menu_page('nav-menus.php');//remove menus page
        remove_menu_page('profile.php');//removes profile menu
        remove_menu_page('edit.php?post_type=slide');//removes slides menu
        remove_menu_page('edit.php?post_type=product');//remove products page
        remove_menu_page('themes.php?page=custom-header');//remove header menu
        remove_menu_page('themes.php?page=custom-background');//removes background menu
        remove_menu_page('options-general.php?page=mailchimpSF_options');//removes mailchimp menu
        remove_menu_page('edit.php?post_type=shop_coupon');//removes coupons menu
        remove_menu_page('separator1');//remove all saperator tabs
        remove_menu_page('separator2');
        remove_menu_page('separator3');
        remove_menu_page('separator4');
        remove_menu_page('separator5');
        remove_menu_page('separator6');
        remove_menu_page('eshopbox');//remove eshopbox menus
        remove_menu_page('admin.php?page=wpseo_dashboard');//remove seo menu
        remove_submenu_page('index.php','admin.php?page=eshopbox_reports'); // Remove eshopbox reports submenu
        remove_submenu_page('index.php','index.php'); // Remove the Home Sub Menu Update
    }
}
add_action( 'admin_menu', 'custom_dashboard_for_orderadmin' );
function remove_custom_menu_for_orderadmin(){
    $user = wp_get_current_user();
    if($user->roles[0]=='orderadmin'){
        global $menu,$submenu,$wp_admin_bar;
        remove_menu_page('wpseo_dashboard');
        remove_menu_page('private_blog_settings');
        remove_action( 'admin_head', 'wooadmin_wrap_menu_div_wpse_19814' );
        remove_action( 'admin_bar_menu', 'wpseo_admin_bar_menu', 95 );
        remove_action( 'admin_bar_menu', 'wp_admin_bar_new_content_menu', 70 );
        remove_action( 'admin_bar_menu', 'wp_admin_bar_comments_menu', 60 );
    }
}
 add_action('admin_init','remove_custom_menu_for_orderadmin');

 //******************order admin code ends here***************************
?>