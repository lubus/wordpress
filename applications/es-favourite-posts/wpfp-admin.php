...
<!--<div class="postbox">
    ...
    <div class="inside" style="display: block;">
        <img src="../eshop-content/plugins/wp-favorite-posts/img/icon_coffee.png" alt="buy me a coffee" style=" margin: 5px; float:left;" />
        ...
        <form action="https://www.paypal.com/cgi-bin/webscr" method="post">
            ...
            ">
            <input type="image" src="../eshop-content/plugins/wp-favorite-posts/img/donate.gif" border="0" name="submit" alt="PayPal - The safer, easier way to pay online.">
        </form>
