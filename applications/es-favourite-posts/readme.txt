...
If you need support [create a topic on support forum](http://boxbeat.org/support/plugin/wp-favorite-posts)

For thank me [go here](http://nxsn.com/projects/wp-favorite-posts/) or [make a donation](http://nxsn.com/donate/)

== Installation ==

1. Unzip into your `/eshop-content/plugins/` directory.
...
= 1.5.4 (2011-11-23) =
* BUGFIX: Thanks to @spectrus http://boxbeat.org/support/topic/plugin-wp-favorite-posts-major-bug-getting-user-favourites?replies=1#post-2465141
...
= 1.0 (2009-02-23) =
* First Release of WP-Favorite Post


New directions to use this plugin


1) Create a Template page in your woocommerce folder inside Theme with defined template and including header and footer(ex-Wishlist.php)
