...
class RegenerateThumbnails {
	...
	function RegenerateThumbnails() {
		// Load up the localization file if we're using BoxBeat in a different language
	...
	function admin_enqueues( $hook_suffix ) {
		...
		// BoxBeat 3.1 vs older version compatibility
