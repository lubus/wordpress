jQuery(document).ready( function($) {
	...
	/*var image_id_post = jQuery('#image_id_post').val(); alert(image_id_post);
	//var image_id_postt = jQuery('#image_id_postt').val(); alert(image_id_postt);
	alert(variation.variation_id);
	if(image_id_post>0){		
            variation.variation_id=image_id_post;alert(variation.variation_id);
