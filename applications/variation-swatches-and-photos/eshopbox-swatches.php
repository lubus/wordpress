<?php
/*
  Plugin Name:Variation Swatches and Photos
  Plugin URI: http://woothemes.com/eshopbox/
  Description: eshopbox Swatches and Photos allows you to configure colors and photos for shoppers on your site to use when picking variations. Requires eshopbox 1.5.7+
  Version: 1.2
  Author: Lucas Stark
...
//if (is_eshopbox_active()) {
    ...
    if (!class_exists('WC_SwatchesAndPhotos')) {
        ...
        class WC_SwatchesPlugin {
            ...
            public function __construct() {
                require 'eshopbox-swatches-template-functions.php';
                ...
                add_action('eshopbox_locate_template', array(&$this, 'locate_template'), 10, 3);
                ...
                add_filter('eshopbox_catalog_settings', array(&$this, 'swatches_image_size_setting'));
            }
            ...
            public function on_init() {
                ...
                add_image_size('swatches_image_size', apply_filters('eshopbox_swatches_size_width_default', $swatch_width ? $swatch_width : 32), apply_filters('eshopbox_swatches_size_height_default', $swatch_height ? $swatch_height : 32), $swatch_image_crop);
            }
    ...
    $GLOBALS['eshopbox_swatches'] = new WC_SwatchesPlugin();
//}
?>
