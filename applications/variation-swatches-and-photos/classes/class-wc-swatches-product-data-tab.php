...
class WC_Swatches_Product_Data_Tab extends WC_EX_Product_Data_Tab_Swatches {
    ...
    public function render_product_tab_content() {
        ...
        <div class="fields">
            ...
            $eshopbox_taxonomies = $eshopbox->get_attribute_taxonomies();
            $eshopbox_taxonomy_infos = array();
            foreach ($eshopbox_taxonomies as $tax) {
                $eshopbox_taxonomy_infos[$eshopbox->attribute_taxonomy_name($tax->attribute_name)] = $tax;
            }
            $tax = null;
            //echo "<pre>";print_r($post);
            if($post->post_status=='publish'){
                //$product=new WC_Product_Variation($post->ID);
            }else{
                $product=new WC_Product_Variation($post->ID);
            }
            ...
            if ($attributes && count($attributes)) :
                ...
                foreach ($attribute_names as $name) :
                    ...
                    if (taxonomy_exists($name)) :
                        ...
                        $eshopbox_taxonomy = $eshopbox_taxonomy_infos[$name];
                        $current_label = isset($eshopbox_taxonomy->attribute_label) && !empty($eshopbox_taxonomy->attribute_label) ? $eshopbox_taxonomy->attribute_label : $eshopbox_taxonomy->attribute_name;
                ...
                <?php $image_sizes = get_intermediate_image_sizes(); ?>
                                        ...
                                        <tr class="field_option field_option_term_default" style="<?php echo $current_type != 'default' ? 'display:none;' : ''; ?>">
                                            ...
                                            <td>
                                                <p>
                <?php _e('eshopbox default select boxes will be used for this product attribute', 'wc_swatches_and_photos'); ?>
                                                </p>
                                            </td>
                                        </tr>
                ...
                <?php foreach ($attribute_terms as $attribute_term) : ?> 
                    ...
                    $current_attribute_image_src = eshopbox_placeholder_img_src();
                                                                                ...
                                                                                <tr class="field_option field_option_image" style="<?php echo $current_attribute_type == 'image' ? '' : 'display:none;' ?>">
                                                                                    ...
                                                                                    <td>
                                                                                        ...
                                                                                        <div style="line-height:60px;">
                                                                                            ...
                                                                                            <button type="submit" class="upload_image_button button" rel="<?php echo $post_id; ?>"><?php _e('Upload/Add image', 'eshopbox'); ?></button>
                                                                                            <button type="submit" class="remove_image_button button" rel="<?php echo $post_id; ?>"><?php _e('Remove image', 'eshopbox'); ?></button>
                                                                                        </div>
    ...
    private function do_javascript() {
        ...
        jQuery('img', current_field_wrapper).attr('src', '<?php echo eshopbox_placeholder_img_src(); ?>');
